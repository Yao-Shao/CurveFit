...
void MainWindow::createToolBar()
{
	...
	*/
	...
	styleComboBox->addItem(tr("Line"), static_cast<int>(LINE));
	styleComboBox->addItem(tr("Quad"), static_cast<int>(QUAD));
	styleComboBox->addItem(tr("Log"), static_cast<int>(LOG));
	styleComboBox->addItem(tr("Exponential"), static_cast<int>(EXP));
	styleComboBox->addItem(tr("Free"), static_cast<int>(FREE));
